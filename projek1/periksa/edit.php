                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="tensi" name="tensi" type="dat e" class="form-control" value="<?= $row['tensi'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="kelurahan_id" class="col-4 col-form-label">Pasien</label>
                                    <div class="col-8">
                                        <?php
                                ...
                                <div class="form-group row">
                                    <label for="kelurahan_id" class="col-4 col-form-label">Dokter</label>
                                    <div class="col-8">
                                        <?php
